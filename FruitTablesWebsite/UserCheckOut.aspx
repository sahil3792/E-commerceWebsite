                    ...
                    <div class="row g-5">
                        <div class="col-md-12 col-lg-6 col-xl-7">
                            ...
                            <div class="form-item">
                                ...
                                <asp:TextBox ID="TextBox4" runat="server" class="form-control" placeholder="House Number Street Name"></asp:TextBox> 
                            </div>
                            <div class="form-item">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center mt-2">
                                                        <img src='<%# Eval("Imagepath") %>' class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                    </div>
                                                </th>
                                                <td class="py-5"><%# Eval("Name") %></td>
                                                <td class="py-5">$<%# Eval("Price") %></td>
                                                <td class="py-5"><%# Eval("Quantity") %></td>
                                                <td class="py-5">$<%# Eval("TotalPrice") %></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                    <tr>
                                        ...
                                        <td class="py-5">
                                            <div class="py-3 border-bottom border-top">
                                                <p class="mb-0 text-dark">$<asp:Label ID="lblSubtotal" runat="server" /></p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-5">
                                            <div class="py-3 border-bottom border-top">
                                                <p class="mb-0 text-dark">$<asp:Label ID="lblTotal" runat="server" /></p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                       ...
                       <!-- <div class="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                        ...
                        <div class="row g-4 text-center align-items-center justify-content-center pt-4">
                            <asp:Button ID="btnPlaceOrder" runat="server" CssClass="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary" Text="Place Order" OnClick="btnPlaceOrder_Click" />
                        </div>
                    </div>
                </div>
            </div>
