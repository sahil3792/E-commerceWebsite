...
namespace Project2
{
    public partial class HrJoiningForm : System.Web.UI.Page
    { SqlConnection conn;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "INSERT INTO Users (Name, Contact, Email, Salary, DOB, DOJ, Urole) VALUES (@Name, @Contact, @Email, @Salary, @DOB, @DOJ, @Urole); SELECT SCOPE_IDENTITY();";
